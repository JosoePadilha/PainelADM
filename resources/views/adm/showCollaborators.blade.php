@extends('site.main')
@section('title', 'PainelADM - Colaboradores')
@section('content')
                        ...
                        <div class="card bg-light">
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button type="button" data-type="see" data-rout="{{ route ('seeCollaborator', $user->id) }}" class="btn btn-sm bg-secondary modalConfirma">
                                        <i class="fa fa-eye"></i>
                                    </button>
