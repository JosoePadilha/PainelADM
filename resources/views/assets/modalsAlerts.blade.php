    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong>Deseja alterar o registro?</strong></h5>
                </div>
            <div class="modal-footer">
                <a href="#" type="button" class="btn btn-info edit-yes"><i class="fa fa-lg fa-thumbs-up"></i></a>
...
<!-- Modal de exclusão dos dados -->
<div class="modal fade" id="modalExcluir"  role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong>Deseja excluir o registro?</strong></h5>
                </div>
            <div class="modal-footer">
                <a href="#" type="button" class="btn btn-info delete-yes"><i class="fa fa-lg fa-thumbs-up"></i></a>
                <a href="#" type="button" data-dismiss="modal" class="btn btn-danger"><i class="fa fa-lg fa-thumbs-down"></i></a>
            </div>
        </div>
    </div>
